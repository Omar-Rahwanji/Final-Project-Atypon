...
<body>
	...
	<form action="/home" method="POST">
		<fieldset>
            ...
            <br /><br />
			<label>Insert</label><input type="text" name="insertStatementCustomer" placeholder="id,name,country,phone,email">
			<input type="submit" name="operation" value="Insert Customer" />
			<br /><br />
			<label>Update</label><input type="text" name="updateStatementCustomer" placeholder="col=value,col=new_value">
			<input type="submit" name="operation" value="Update Customer" />
            <br /><br />
			<label>Delete</label><input type="text" name="deleteStatementCustomer" placeholder="col=value">
	...
	<form action="/home" method="POST">
    	<fieldset>
    		...
    		<input type="submit" name="operation" value="Update Account" />
            <br /><br />
    		<label>Delete</label><input type="text" name="deleteStatementAccount" placeholder="col=value">
